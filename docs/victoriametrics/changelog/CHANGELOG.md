...
* FEATURE: [stream aggregation](https://docs.victoriametrics.com/victoriametrics/stream-aggregation/): add `dedup_use_insert_timestamp` option and related CLI flags to prefer samples with the highest insert timestamp when deduplicating.
